...
python scripts/preprocessing/extract_spectrograms.py --corpus $1 --length 5 --clip 60 --window_size 0.025 --window_shift 0.010 --pre_emphasis 0.97 --labels datasets/$1/labels.csv --input datasets/$1/files.txt --netcdf output/$1/spectrograms_40.nc --mel_bands 40
python scripts/preprocessing/extract_spectrograms.py --corpus $1 --length 5 --clip 60 --window_size 0.025 --window_shift 0.010 --pre_emphasis 0.97 --labels datasets/$1/labels.csv --input datasets/$1/files.txt --netcdf output/$1/spectrograms_240.nc --mel_bands 240
