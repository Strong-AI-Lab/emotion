...
corpora: Dict[str, CorpusInfo] = {
    ...
    "emofilm": CorpusInfo("EmoFilm"),
    "enterface": CorpusInfo("eNTERFACE"),
    "iemocap": CorpusInfo(
        "IEMOCAP",
